...
local calculateTabData = function(tabs, attrs)
	...
	tabsWithMeta.y = require("tools/lib/tweenableValue"):create(attrs.HEIGHT - 40, { speed = 12 })
	tabsWithMeta.h = 30
...
return {
	init = function(self, params)
		...
		self.BUFFERED_GRAFX = require("tools/lib/bufferedGraphics"):create(GRAFX, self.WIDTH, self.PANE_HEIGHT)
