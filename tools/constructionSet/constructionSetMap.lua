	...
	create = function(self, params)
		return {
			...
			drawSonic2Blocks = function(self)
				...
				x = self:drawZone(0, 10496, self:getColor(0.5, 0.5, 0.5, -6000), { { w = 44, h = 8 }, { w = 46.5, h = 8 }})
				self:drawZone(x + 256, 10496, self:getColor(0.5, 0.5, 0.5, -6000), { { w = 42.5, h = 8 }, { w = 56.0, h = 8 }})
			
				x = self:drawZone(0, 12800, self:getColor(0.5, 0.5, 0.5, -6000), { { w = 41.5, h = 8 }, { w = 52.0, h = 8 }})
				self:drawZone(x + 256, 12800, self:getColor(0.5, 0.5, 0.5, -6000), { { w = 37.0, h = 8 }, { w = 38.0, h = 8 }})

				x = self:drawZone(0, 15104, self:getColor(0.5, 0.5, 0.5, -6000), { { w = 49, h = 8 }, { w = 46.5, h = 8 }})
			...
			drawSonicCDBlocks = function(self)
				...
				x = self:drawZone(0, 23296, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 48, h = 6 }, { w = 48, h = 6 }, { w = 48, h = 6 }, { w = 48, h = 6 }})
				...
				x = self:drawZone(0, 26880, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 30, h = 6 }, { w = 30, h = 6 }, { w = 30, h = 6 }, { w = 30, h = 6 }})
				...
				x = self:drawZone(0, 28672, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 44, h = 4 }, { w = 44, h = 4 }, { w = 44, h = 4 }, { w = 44, h = 4 }})
				...
				x = self:drawZone(0, 31232, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 36, h = 8 }, { w = 36, h = 8 }, { w = 36, h = 8 }, { w = 36, h = 8 }})
				...
				x = self:drawZone(0, 35840, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 48, h = 6 }, { w = 48, h = 6 }, { w = 48, h = 6 }, { w = 48, h = 6 }})
				self:drawZone(0, 37632, self:getColor(0.2, 0.2, 0.2, -7000), { { w = 48, h = 8 }, { w = 48, h = 8 }, { w = 48, h = 8 }, { w = 48, h = 8 }})
			
				x = self:drawZone(0, 39936, self:getColor(0.3, 0.3, 0.3, -7000), { { w = 32, h = 8 }, { w = 32, h = 8 }, { w = 32, h = 8 }, { w = 32, h = 8 }})
			...
			drawSonicAndKnucklesBlocks = function(self)
				...
				self:drawZone(x + 256, 64895, self:getColor(1, 0, 0, -9000), { { w = 116, h = 2 }})
			end,
