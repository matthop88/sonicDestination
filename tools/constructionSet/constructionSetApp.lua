...
local CHUNKS_4_PANEL  = require("tools/constructionSet/panels/chunksPanel"):create(STICKY_MOUSE, { 9, 22, 40, 56, 57, 4, 5 })
...
local PROPERTIES = require("tools/constructionSet/properties")
