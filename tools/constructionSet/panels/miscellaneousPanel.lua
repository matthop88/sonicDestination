return {
    create = function(self)
        ...
        table.insert(buttonList, require("tools/constructionSet/miscellaneous/backgrounds/backgroundsButton"):create {})
        table.insert(buttonList, require("tools/constructionSet/miscellaneous/time/timeButton"):create {})
        table.insert(buttonList, require("tools/constructionSet/miscellaneous/rings/ringsButton"):create {})
