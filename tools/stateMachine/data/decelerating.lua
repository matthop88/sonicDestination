return {
    ...
    { type = "BOX",   label = "Accelerate Right", x  = 25,   y  =  5,   w  =  6, h = 13   },
    ...
    { type = "ARROW", label = "L On",  from = "Stand Right", to = "Run Left",    y =  6   },
    ...
    { type = "ARROW", label = "R On",  from = "Stand Left",  to = "Run Right",   y = 15   },
}
