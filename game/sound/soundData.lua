return {
	...
	ringCollectL   = { label = "Ring Collect L",   filename = "ring-collect-L.mp3",    volume = 0.4,  startPoint =  1636, endPoint =  55260, effect = { type = "Reverb", delay = 0.4, strength = 0.8 } },
	ringCollectR   = { label = "Ring Collect R",   filename = "ring-collect-R.mp3",    volume = 0.4,  startPoint =  2984, endPoint =  58018, effect = { type = "Reverb", delay = 0.4, strength = 0.8 } },
    ...
    bowlingStrike  = { 
    	label = "Bowling Strike",   filename = "extra/emycutiepantsBowlingStrike.mp3", effect = { type = "Reverb", delay = 0.4, strength = 0.8 },
