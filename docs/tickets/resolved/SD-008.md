...
- [X] Ring dissolves with twinkling animation when Sonic collides with ring.
- [X] Ring behind Sonic, twinkling over top of Sonic.
- [X] Ring twinkling sound when ring is collected.
- [X] Ring sounds are played alternately from the left ear to the right ear.
